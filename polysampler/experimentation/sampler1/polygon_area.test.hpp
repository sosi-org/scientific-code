...
void test1_convex_polygon_area()
{
    ...
    fixedsize_polygon_with_side_metadata_t poly1 = t2patch(square.trigulation[0], square.points);
    double a = convex_polygon_area<double>(poly1);

    assert_equality_real<double>(a, 1.0);
}
/*
fixedsize_polygon_with_side_metadata_t  t2patch(const simple_polygi_t& polyg)
*/
